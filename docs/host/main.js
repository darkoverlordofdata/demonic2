...
window.addEventListener("load", (event) => {
	setPlugin("../PedalBoard-WAC2022/src/index.js");
});
...
const toggleLiveInput = () => {
	...
	if (!liveInputActivated) {
		button.innerHTML = "Live input: <span style='color:#99c27a;'>On </span>";
		liveInputGainNode.gain.setValueAtTime(1, audioContext.currentTime);
	} else {
		button.innerHTML = "Live input: <span style='color:#cc7c6e;'>Off</span>";
